...
class player {
    ...
    inicializaMatriz () {
         ...
         mostrarNumero(e) {
            ...
            if ( item.minas[parseInt(auxstr[0], 10)][parseInt(auxstr[1], 10)] == 0) {
                divObj.style.backgroundColor = "white";
                 abrirAlrededor(parseInt(auxstr[0], 10), parseInt(auxstr[1], 10),  item.minas);
            } else {
                if ( item.minas[parseInt(auxstr[0], 10)][parseInt(auxstr[1], 10)] != "*") {
                    document.getElementById(myid).innerHTML = "<p style='margin-top:15px;'>" +  item.minas[parseInt(auxstr[0], 10)][parseInt(auxstr[1], 10)] + "</p>";
                    divObj.style.backgroundColor = "white";
                } else {
                    divObj.style.backgroundImage = "url(assets/img/bomba.gif)";
                     abrirTablero( item.minas);
                    swal(
                        'Oops...',
